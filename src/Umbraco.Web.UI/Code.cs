...
{
    public class Code : IUserComposer
    {
        ...
        {
            if (e.TryGetValue("umbracoSettings", out var obj) && obj is IDictionary<string, object> settings)
            {
                settings["showAllowSegmentationForDocumentTypes"] = true;
            }
        }
    }
